 ...
 *********************************************************/
class cafeEntryPage extends StatefulWidget {
  @override
  _cafeEntryPageState createState() => _cafeEntryPageState();
}

class _cafeEntryPageState extends State<cafeEntryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Suivi de vos frais : Pause café'),
      ),
      body: Stack(
        children: [
          // Image de fond
            ...
            child: SingleChildScrollView( // Permettre le défilement si le contenu dépasse l'écran
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    onPressed: () {
                      FirebaseFirestore.instance.collection('cafe').add({
                        'date': selectedDate,
                        'etapes': cafeController.value.text,
                      });
