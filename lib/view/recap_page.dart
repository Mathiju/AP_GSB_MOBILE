 ...
 *********************************************************/
class recapEntryPage extends StatefulWidget {
  @override
  _recapEntryPageState createState() => _recapEntryPageState();
}

class _recapEntryPageState extends State<recapEntryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Suivi de vos frais : Recap'),
      ),
      body: Stack(
        children: [
          // Image de fond
