...
/**********************************************************
 # Classe des notes de frais nourriture de l'application
 *********************************************************/
...
class _foodEntryPageState extends State<foodEntryPage> {
  ...
  TextEditingController foodController = TextEditingController(); // Contrôleur pour le champ de texte des kilomètres
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Suivi de vos frais : Repas'),
      ),
      body: Stack(
        children: [
          // Image de fond
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Veuillez sélectionner une date et entrer le nombre de repas.',
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        controller: foodController, // Associer le contrôleur
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (selectedDate != null && foodController.text.isNotEmpty) {
                        // Logique pour traiter les données
                        print('Date sélectionnée : ${selectedDate}');
                        print('Repas : ${foodController.text}');
                      } else {
                        // Afficher une alerte si la date ou repas ne sont pas renseignés
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Veuillez sélectionner une date et entrer un nombre de repas.')),
                        );
                      }
                    },
                    child: Text('Valider'),
