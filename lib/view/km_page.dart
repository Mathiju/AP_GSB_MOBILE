...
/**********************************************************
 # Classe des notes de frais route de l'application
 *********************************************************/
class KmEntryPage extends StatefulWidget {
  @override
  _KmEntryPageState createState() => _KmEntryPageState();
}

class _KmEntryPageState extends State<KmEntryPage> {
  DateTime? selectedDate; // Variable pour stocker la date sélectionnée
  TextEditingController kmController = TextEditingController(); // Contrôleur pour le champ de texte des kilomètres
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Suivi de vos frais : Kilomètres'),
      ),
      body: Stack(
        children: [
          // Image de fond
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Veuillez sélectionner une date et entrer des kilomètres.',
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        controller: kmController, // Associer le contrôleur
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (selectedDate != null && kmController.text.isNotEmpty) {
                        ...
                        print('Kilomètres : ${kmController.text}');
                      } else {
                        // Afficher une alerte si la date ou les kilomètres ne sont pas renseignés
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Veuillez sélectionner une date et entrer des kilomètres.')),
                        );
                      }
                    },
                    child: Text('Valider'),
