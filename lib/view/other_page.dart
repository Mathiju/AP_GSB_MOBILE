...
/**********************************************************
 # Classe des notes de frais café de l'application
 *********************************************************/
class otherEntryPage extends StatefulWidget {
  @override
  _otherEntryPageState createState() => _otherEntryPageState();
}

class _otherEntryPageState extends State<otherEntryPage> {
  DateTime? selectedDate; // Variable pour stocker la date sélectionnée
  TextEditingController cafeController = TextEditingController(); // Contrôleur pour le champ de texte des kilomètres
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Suivi de vos frais : Autres'),
      ),
      body: Stack(
        children: [
          // Image de fond
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/interogation.jpg', 
                      height: 100,
                      width: 100,
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: const Color.fromARGB(169, 100, 53, 53), 
                      ...
                      child: Text(
                        'Veuillez sélectionner une date et entrer le nombre détapes.',
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        controller: cafeController, // Associer le contrôleur
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (selectedDate != null && cafeController.text.isNotEmpty) {
                        // Logique pour traiter les données
                        print('Date sélectionnée : ${selectedDate}');
                        print('Etapes : ${cafeController.text}');
                      } else {
                        // Afficher une alerte si la date ou étapes ne sont pas renseignés
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Veuillez sélectionner une date et entrer un nombre détapes.')),
                        );
                      }
                    },
                    child: Text('Valider'),
